...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display': ['120px', { lineHeight: '1', letterSpacing: '-0.03em' }],
        'display-md': ['80px', { lineHeight: '1', letterSpacing: '-0.02em' }],
        'display-sm': ['64px', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
        'headline': ['42px', { lineHeight: '1.2', letterSpacing: '-0.01em' }],
        'headline-sm': ['32px', { lineHeight: '1.3', letterSpacing: '-0.01em' }],
        'section': ['72px', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
        'section-sm': ['48px', { lineHeight: '1.2', letterSpacing: '-0.01em' }],
      },
      borderRadius: {
